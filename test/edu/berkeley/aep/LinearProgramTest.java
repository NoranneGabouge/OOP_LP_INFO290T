...
public class LinearProgramTest {
    ...
    LinearProgram LPa = new LinearProgram(1,0,0, Direction.MAX);

    @Test
    public void testHasFeasiblePointForZeroIsFeasibleForLPa(){
        assertTrue(LPa.hasFeasiblePoint(new int[]{0}, new int[0], new double[0]));
    }

    @Test
    public void testHasFeasiblePointForTwoIsNotFeasibleForLPa(){
        assertFalse(LPa.hasFeasiblePoint(new int[]{2}, new int[0], new double[0]));
    }

    @Test(expected = IllegalArgumentException.class )
    public void testAddConstraintsToLPaWithTwoCoeffsShouldThrowAnException(){
        Constraint constra = new Constraint(new double[2], ConstraintDirection.GREATERTHAN, 0);
        LPa.addConstraints(constra);
    }

    @Test(expected = IllegalArgumentException.class)
    public void testSetObjectiveCostVectorForLPaWithTwoCoeffsForBinaryVarsShouldThrowAnException() {
     ...
     */
    public void testHasFeasiblePointForLPbWithMinusOneMinusOne(){
        LinearProgram LPb = new LinearProgram(0,1,1, Direction.MIN);
        LPb.setObjective(new double[]{1,1});
        Constraint xnonnegative=new Constraint(new double[]{1,0}, ConstraintDirection.GREATERTHAN, 0);
        Constraint ynonnegative=new Constraint(new double[]{0,1}, ConstraintDirection.GREATERTHAN,  0);
     ...
     */
    public void testPointIsFeasibleForLPc(){
        LinearProgram LPc = new LinearProgram(2,3,2, Direction.MIN);
        LPc.setObjective(new double[]{3,2,-1,-4,-5,8,-1});
        Constraint constr1 = new Constraint(new double[]{1,1,0,0,0,0,0}, ConstraintDirection.LESSTHAN, 1);
        Constraint constr2 = new Constraint(new double[]{0,0,1,-2,1,0,0}, ConstraintDirection.GREATERTHAN,
                5);
        Constraint constr3 = new Constraint(new double[]{0,0,0,10,0,-1,0}, ConstraintDirection.LESSTHAN,
                3);
        Constraint constr4 = new Constraint(new double[]{0,0,0,0,0,0,1}, ConstraintDirection.GREATERTHAN,
                9);
    ...
    public void linearRelaxationOfLPdIsEqualToLPd(){
        LinearProgram LPd = new LinearProgram(0,0,1, Direction.MAX);
        LPd.setObjective(new double[]{3});
        Constraint constr1 = new Constraint(new double[]{1}, ConstraintDirection.LESSTHAN, 2);
    ...
    public void linearRelaxationOfLPdIsEqualToACopyOfLPd(){
        ...
        Constraint constr1 = new Constraint(new double[]{1}, ConstraintDirection.LESSTHAN, 2);
        LPd.addConstraints(constr1);
        LinearProgram LPdCopy = new LinearProgram(0,0,1, Direction.MAX);
        LPdCopy.setObjective(new double[]{3});
        Constraint constr1Copy = new Constraint(new double[]{1}, ConstraintDirection.LESSTHAN, 2);
    ...
    public void linearRelaxationOfLPdIsEqualToACopyOfLPdAfterMultiplyingConstraintByMinusTwo(){
        ...
        Constraint constr1 = new Constraint(new double[]{1}, ConstraintDirection.LESSTHAN, 2);
        LPd.addConstraints(constr1);
        LinearProgram LPdMultiplied = new LinearProgram(0,0,1,
                Direction.MAX);
        LPdMultiplied.setObjective(new double[]{3});
        Constraint constr1Multiplied = new Constraint(new double[]{-2}, ConstraintDirection.GREATERTHAN, -4);
    ...
    public void anLPShouldBeEqualToTheLPObtainedAfterChangingTheOrderOfTheConstraints(){
        LinearProgram LPc = new LinearProgram(2,3,2, Direction.MIN);
        LPc.setObjective(new double[]{3,2,-1,-4,-5,8,-1});
        LinearProgram LPcShuffle = new LinearProgram(2,3,2, Direction.MIN);
        LPcShuffle.setObjective(new double[]{3,2,-1,-4,-5,8,-1});
        Constraint constr1 = new Constraint(new double[]{1,1,0,0,0,0,0}, ConstraintDirection.LESSTHAN, 1);
        Constraint constr2 = new Constraint(new double[]{0,0,1,-2,1,0,0}, ConstraintDirection.GREATERTHAN,
                5);
        Constraint constr3 = new Constraint(new double[]{0,0,0,10,0,-1,0}, ConstraintDirection.LESSTHAN, 3);
        Constraint constr4 = new Constraint(new double[]{0,0,0,0,0,0,1}, ConstraintDirection.GREATERTHAN,
                9);
        LPc.addConstraints(constr1);
        LPc.addConstraints(constr2);
    ...
    public void linearRelaxationOfLPeIsEqualToLPeRelax(){
        LinearProgram LPe = new LinearProgram(1,1,0, Direction.MAX);
        LPe.setObjective(new double[]{3,0});
        LinearProgram LPeRelax = new LinearProgram(0,0,2, Direction.MAX);
        LPeRelax.setObjective(new double[]{3,0});
        Constraint xnonnegative = new Constraint(new double[]{1,0}, ConstraintDirection.GREATERTHAN, 0);
        Constraint xlessthanOne = new Constraint(new double[]{1,0}, ConstraintDirection.LESSTHAN, 1);
    ...
    @Test
    public void directionDoesNotMatterIfObjectiveIsZero(){
        LinearProgram LP1 = new LinearProgram(0,0,1, Direction.MAX);
        LP1.setObjective(new double[]{0});
        LinearProgram LP2 = new LinearProgram(0,0,1, Direction.MIN);
        LP2.setObjective(new double[]{0});
        assertEquals(LP1,LP2);
    }

    @Test
    public void directionDoesNotMatterIfGlobalCoeffIsZero(){
        LinearProgram LP1 = new LinearProgram(0,0,1, Direction.MAX);
        LP1.setObjective(new double[]{0});
        LinearProgram LP2 = new LinearProgram(0,0,1, Direction.MAX);
    ...
    public void reversingObjectiveDoesNotChangeTheOptimizationProblem(){
        LinearProgram LPe = new LinearProgram(0,0,2, Direction.MAX);
        LPe.setObjective(new double[]{3,0});
        LinearProgram LPeRelaxReverse = new LinearProgram(0,0,2,
                Direction.MIN);
